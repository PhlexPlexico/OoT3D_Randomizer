...
void HintTable_Init() {
    ...
    hintTable[WAY_OF_THE_HERO] =
        HintText::Exclude({ Text{ " is on the way of the hero.", /*french*/ " est sur le chemin du héros.",
    ...
    hintTable[ZR_FROGS_OCARINA_GAME] = HintText::Always(
        ...
        Text{ "the final reward from the #Frogs of Zora's River# is",
              /*french*/ "la dernière récompense des #grenouilles du fleuve zora# est",
    ...
    hintTable[SONG_FROM_COMPOSERS_GRAVE] = HintText::Sometimes({
        ...
        Text{ "#ReDead in the Composers' Grave# guard",
              /*french*/ "les #Remorts du tombeau des compositeurs# protègent",
    ...
    hintTable[SHEIK_IN_FOREST] = HintText::Sometimes({
        // obscure text
        Text{ "#in a meadow# Sheik teaches", /*french*/ "Sheik confiera, #dans une clairière#,",
    ...
    hintTable[SHEIK_IN_ICE_CAVERN] = HintText::Sometimes({
        // obscure text
        Text{ "the #frozen cavern# echoes with", /*french*/ "Sheik confiera, #dans une caverne étoilée#,",
              /*spanish*/ "en la #caverna de hielo# retumban los ecos de" },
    });

    hintTable[SHEIK_IN_KAKARIKO] = HintText::Sometimes({
        // obscure text
        Text{ "a #ravaged village# mourns with", /*french*/ "Sheik confirera, #au cœur d'un village ravagé#,",
    ...
    hintTable[MARKET_10_BIG_POES] = HintText::Sometimes(
        ...
        {},
        // clear text
        Text{ "catching #Big Poes# leads to", /*french*/ "#d'attraper des fantômes# donne",
    ...
    hintTable[DMT_TRADE_EYEDROPS] = HintText::Sometimes({
        // obscure text
        Text{ "while you wait, #Biggoron# gives", /*french*/ "pendant que tu attends, #Grogoron# donne",
    ...
    hintTable[KAK_50_GOLD_SKULLTULA_REWARD] = HintText::Sometimes(
        {
            ...
            Text{ "#50 spider souls# yields", /*french*/ "#50 âmes# donnent",
    ...
    hintTable[KAK_40_GOLD_SKULLTULA_REWARD] = HintText::Sometimes(
        {
            ...
            Text{ "#40 spider souls# yields", /*french*/ "#40 âmes# donnent",
    ...
    hintTable[KAK_30_GOLD_SKULLTULA_REWARD] = HintText::Sometimes(
        {
            ...
            Text{ "#30 spider souls# yields", /*french*/ "#30 âmes# donnent",
    ...
    hintTable[KAK_20_GOLD_SKULLTULA_REWARD] = HintText::Sometimes(
        {
            ...
            Text{ "#20 spider souls# yields", /*french*/ "#20 âmes# donnent",
    ...
    hintTable[ZORAS_DOMAIN_TO_ZD_STORMS_GROTTO] = HintText::Entrance({
        // obscure text
        Text{ "a #storm within Zora's Domain# reveals", /*french*/ "la #tempête dans le domaine des Zoras# révèle",
    ...
    hintTable[SACRED_FOREST_MEADOW] = HintText::Exclude({
        ...
        Text{ "Sacred Forest Meadow", /*french*/ "le bosquet sacré", /*spanish*/ "la pradera sagrada del bosque",
              /*italian*/ "la radura sacra", /*german*/ "Deutsch" },
    });

    hintTable[HYRULE_FIELD] = HintText::Exclude({
        // obscure text
        Text{ "Hyrule Field", /*french*/ "la plaine d'Hyrule", /*spanish*/ "la Llanura de Hyrule",
              /*italian*/ "la piana di Hyrule", /*german*/ "Deutsch" },
    });

    hintTable[LAKE_HYLIA] = HintText::Exclude({
        // obscure text
        Text{ "Lake Hylia", /*french*/ "le lac Hylia", /*spanish*/ "el Lago Hylia", /*italian*/ "il Lago Hylia",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[KAKARIKO_VILLAGE] = HintText::Exclude({
        ...
        Text{ "Kakariko Village", /*french*/ "le village Cocorico", /*spanish*/ "Kakariko",
              /*italian*/ "il villaggio Calbarico", /*german*/ "Deutsch" },
    });

    hintTable[THE_GRAVEYARD] = HintText::Exclude({
        // obscure text
        Text{ "the Graveyard", /*french*/ "le cimetière", /*spanish*/ "el cementerio", /*italian*/ "il cimitero",
              /*german*/ "Deutsch" },
    });

    hintTable[DEATH_MOUNTAIN_TRAIL] = HintText::Exclude({
        // obscure text
        Text{ "Death Mountain Trail", /*french*/ "le chemin du mont de la Mort",
              /*spanish*/ "el sendero de la Montaña de la Muerte", /*italian*/ "il sentiero del Monte Morte",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[GORON_CITY] = HintText::Exclude({
        ...
        Text{ "Goron City", /*french*/ "le village Goron", /*spanish*/ "la Ciudad Goron",
              /*italian*/ "la città dei Goron", /*german*/ "Deutsch" },
    });

    hintTable[DEATH_MOUNTAIN_CRATER] = HintText::Exclude({
        // obscure text
        Text{ "Death Mountain Crater", /*french*/ "le cratère du mont de la Mort",
              /*spanish*/ "el cráter de la Montaña de la Muerte", /*italian*/ "il cratere del Monte Morte",
              /*german*/ "Deutsch" },
    });

    hintTable[ZORAS_RIVER] = HintText::Exclude({
        // obscure text
        Text{ "Zora's River", /*french*/ "le fleuve Zora", /*spanish*/ "el Río Zora", /*italian*/ "il Fiume Zora",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[COLOSSUS_GREAT_FAIRY_FOUNTAIN] = HintText::Region({
        // obscure text
        Text{ "a #Great Fairy Fountain#", /*french*/ "la #grande fée du colosse#",
              /*spanish*/ "una fuente de la Gran Hada" },
    });

    hintTable[HC_GREAT_FAIRY_FOUNTAIN] = HintText::Region({
        // obscure text
        Text{ "a #Great Fairy Fountain#", /*french*/ "la #grande fée du château#",
              /*spanish*/ "una fuente de la Gran Hada" },
    });

    hintTable[OGC_GREAT_FAIRY_FOUNTAIN] = HintText::Region({
        // obscure text
        Text{ "a #Great Fairy Fountain#", /*french*/ "la #grande fée des ruines#",
              /*spanish*/ "una fuente de la Gran Hada" },
    });

    hintTable[DMC_GREAT_FAIRY_FOUNTAIN] = HintText::Region({
        // obscure text
        Text{ "a #Great Fairy Fountain#", /*french*/ "la #grande fée du volcan#",
              /*spanish*/ "una fuente de la Gran Hada" },
    });

    hintTable[DMT_GREAT_FAIRY_FOUNTAIN] = HintText::Region({
        // obscure text
        Text{ "a #Great Fairy Fountain#", /*french*/ "la #grande fée de la montagne#",
              /*spanish*/ "una fuente de la Gran Hada" },
    });

    hintTable[ZF_GREAT_FAIRY_FOUNTAIN] = HintText::Region({
        // obscure text
        Text{ "a #Great Fairy Fountain#", /*french*/ "la #grande fée de la fontaine#",
              /*spanish*/ "una fuente de la Gran Hada" },
    });
    ...
    hintTable[GRAVEYARD_HEART_PIECE_GRAVE] = HintText::Region({
        // obscure text
        Text{ "a chest spawned by #Sun's Song#", /*french*/ "le #tombeau avec un mort#",
    ...
    hintTable[JUNK60] = HintText::Junk({
        ...
        Text{ "You found a spiritual Stone! By which I mean, I worship Nayru.",
              /*french*/ "Vous avez trouvé une pierre spirituelle! En effet, je vénère la déesse Hylia.",
    ...
    hintTable[BRIDGE_VANILLA_HINT] = HintText::Bridge({
        // obscure text
        Text{ "The awakened ones will await for the&Hero to collect the #Shadow and Spirit&Medallions# as well as the "
              "#Light Arrows#.",
              /*french*/
              ...
              "a la #flecha de luz#.",
              /*italian*/
              "I Saggi aspetteranno che l'Eroe&ottenga sia i #medaglioni dell'Ombra&e dello Spirito# che la #freccia "
              "di luce#.",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[BRIDGE_STONES_HINT] = HintText::Bridge({
        ...
        Text{ "The awakened ones will await for the&Hero to collect #%d |Spiritual Stone|Spiritual Stones|#.",
              /*french*/
              "Les êtres de sagesse attendront le&héros muni de #%d |pierre spirituelle|pierres spirituelles|#.",
    ...
    hintTable[BRIDGE_REWARDS_HINT] = HintText::Bridge({
        // obscure text                                                  singular                     plural
        Text{ "The awakened ones will await for the&Hero to collect #%d |Spiritual Stone&or Medallion|Spiritual "
              "Stones&and Medallions|#.",
              /*french*/
              "Les êtres de sagesse attendront le&héros muni de #%d |pierre spirituelle&ou médaillon|pierres "
              "spirituelles&et médaillons|#.",
              /*spanish*/
              "Los sabios aguardarán a que el héroe&obtenga #%d |piedra espiritual o medallón|piedras espirtuales y "
              "medallones|#.",
              /*italian*/
              "I Saggi aspetteranno che l'Eroe&ottenga #%d |pietra spirituale o medaglione|pietre spirituali o "
              "medaglioni|#.",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[LACS_VANILLA_HINT] = HintText::LACS({
        ...
        Text{
            ...
            /*italian*/
            "E la chiave del #re del male# sarà&ricevuta da Zelda dopo aver ottenuto&i #medaglioni dell'Ombra e dello "
            "Spirito#.",
            /*german*/ "Deutsch" },
    });
    ...
    hintTable[LACS_STONES_HINT] = HintText::LACS({
        ...
        Text{
            ...
            "espirituales|#.",
            /*italian*/
            "E la chiave del #re del male# sarà&ricevuta da Zelda dopo aver ottenuto&#%d |pietra spirituale|pietre "
            "spirituali|#.",
            /*german*/ "Deutsch" },
    });
    ...
    hintTable[LACS_REWARDS_HINT] = HintText::LACS({
        ...
        Text{ "And the #evil one#'s key will be&provided by Zelda once #%d |Spiritual&Stone or Medallion# "
              ...
              /*french*/
              "Aussi, Zelda crééra la clé du&#Malin# avec #%d |pierre spirituelle&et des médaillon|pierres "
              "spirituelles&et des médaillons|#.",
              /*spanish*/
              ...
              /*italian*/
              "E la chiave del #re del male# sarà&ricevuta da Zelda dopo aver ottenuto&#%d |pietra spirituale o "
              "medaglione|pietre spirituali o medaglioni|#.",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[LACS_TOKENS_HINT] = HintText::LACS({
        // obscure text                                                     singular                 plural
        Text{
            "And the #evil one#'s key will be&provided by Zelda once #%d |Gold&Skulltula Token# is|Gold&Skulltula "
    ...
    hintTable[ADULT_ALTAR_TEXT_START] = HintText::Altar({
        // obscure text
        Text{ "When evil rules all, an awakening voice from the Sacred Realm will call those destined to be Sages, who "
              "dwell in the #five temples#.",
              /*french*/
              ...
              /*italian*/
              "Quando il male regnerà sovrano, una voce proveniente dalla terra sacra riunirà i Saggi dei #cinque "
              "santuari#.",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[ADULT_ALTAR_TEXT_END] = HintText::Altar({
        // obscure text
        Text{
            "Together with the Hero of Time, the&awakened ones will bind the evil and&return the light of peace to the "
            "world...",
            /*french*/
            "Ensemble avec le Héros du Temps,&ces Sages emprisonneront le mal et&réinstaureront la lumière de paix "
            "dans&le monde...",
            /*spanish*/
    ...
    hintTable[VALIDATION_LINE] = HintText::Validation({
        ...
        Text{ "Hmph... Since you made it this far, I'll let you know what glorious prize of Ganon's you likely missed "
              ...
              "en mi torre.^He aquí...^",
              /*italian*/
              "Bah! Visto che sei arrivato fin qui, ti rivelerò quale incredibile tesoro ti sei probabilmente perso "
              "nella mia torre...^Ammira...^ ",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[YOUR_POCKET] = HintText::Exclude({
        // obscure text
        Text{ "your pocket", /*french*/ "tes poches", /*spanish*/ "tu bolsillo", /*italian*/ "le tue tasche",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[GANON_LINE04] = HintText::GanonLine({
        ...
        Text{ "You'll never deflect my bolts of energy with your sword, then shoot me with those Light Arrows you "
              ...
              "que tendrás.",
              /*italian*/
              "Non rifletterai mai i miei attacchi magici con quella spada, tantomeno mi colpirai con quelle frecce di "
              "luce che ti ritrovi!",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[GANON_LINE06] = HintText::GanonLine({
        ...
        Text{ "Zelda is probably going to do something stupid, like send you back to your own timeline.^So this is "
              ...
              /*italian*/
              "Zelda farà senz'altro qualche stupidaggine, tipo mandarti indietro nel tempo creando una divergenza "
              "temporale.^Sei sicuro di voler salvare questa tonta?",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[GANON_LINE07] = HintText::GanonLine({
        ...
        Text{ "What about Zelda makes you think she'd be a better ruler than I?^I saved Lon Lon Ranch,&fed the "
              ...
              /*italian*/
              "Cosa ti fa pensare che Zelda governerebbe meglio di me?^Ho salvato la Fattoria Lon Lon, ho dato da "
              "mangiare agli affamati, e ho un castello volante!",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[CARPET_SALESMAN_DIALOG_FIRST] = HintText::MerchantsDialogs({
        ...
        Text{ "Welcome!^I am selling stuff, strange and rare, from&all over the world to everybody. Today's&special "
              ...
              "oferta de hoy es...^¡",
              /*italian*/
              "Benvenuto!^Vendo merce strana e introvabile che&proviene da ogni parte del mondo.&Oggi il pezzo forte "
              "è...^",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[CARPET_SALESMAN_DIALOG_SECOND] = HintText::MerchantsDialogs({
        ...
        Text{ "! Terrifying!&I won't tell you what it is until I see the&money...^How about #200 Rupees#?&&" +
              ...
              /*italian*/ "! Non ti dico di che si&tratta finché non vedo la grana.^Hai #200 rupie#?&&" +
                  TWO_WAY_CHOICE() + "#Tieni!&Veramente no...#",
              /*german*/ "Deutsch" },
    });
    ...
    hintTable[CARPET_SALESMAN_DIALOG_FOURTH] = HintText::MerchantsDialogs({
        ...
        Text{ "!#^The mark that will lead you to the #Spirit&Temple# is the #flag on the " + IF_NOT_MQ() + "left" +
              ...
              /*italian*/ "!#^La direzione per il #Santuario dello Spirito# è indicata dalla #bandiera sulla " +
                  IF_NOT_MQ() + "sinistra" + MQ_ELSE() + "destra" + MQ_END() + "# del negozio. A presto!",
              /*german*/ "Deutsch" },
    });
}
