...
void InitTrickNames() {
    ...
    trickNameTable[GI_SWORD_MASTER] = { Text{ "Goddess Sword", "Épée de la déesse", "Espada Divina" },
    ...
    trickNameTable[GI_WEIRD_EGG] = { Text{ "Poached Egg", "Œuf à la coque", "Huevo pasado" },
    ...
    trickNameTable[GI_STONE_OF_AGONY] = { Text{ "Shard of Agahnim", "Fragment d'agonie", "Piedra de Agahnim" },
    ...
    trickNameTable[0xB8] = { Text{ "Diamond Hearts", "Cœurs de diamant", "Contenedor de diamante" },
                             Text{ "Double Damage", "Double souffrance", "Doble daño receptivo" },
                             Text{ "Quadruple Defence", "Quadruple défence", "Defensa cuádruple" } };

    trickNameTable[GI_POCKET_EGG] = { Text{ "Poached Egg", "Œuf à la coque", "Huevo pasado" },
                                      Text{ "Lon Lon Egg", "Œuf Lon Lon", "Huevo Lon Lon" },
    ...
    trickNameTable[GI_PERSCRIPTION] = { Text{ "Biggoron's Prescription", "Ordonnance de Grogoron",
                                              "Receta de Biggoron" },
