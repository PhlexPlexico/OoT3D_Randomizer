...
void HintTable_Init_Item() {
    hintTable[KOKIRI_SWORD] = HintText::Item(
        ...
        Text{ "the Kokiri Sword", /*french*/ "l'épée Kokiri", /*spanish*/ "la Espada Kokiri",
              /*italian*/ "la spada dei Kokiri", /*german*/ "Deutsch" });
    ...
    hintTable[MASTER_SWORD] = HintText::Item(
        ...
        Text{ "the Master Sword", /*french*/ "l'épée de légende", /*spanish*/ "la Espada Maestra",
              /*italian*/ "la spada suprema", /*german*/ "Deutsch" });
    ...
    hintTable[GIANTS_KNIFE] = HintText::Item(
        ...
        Text{ "the Giant's Knife", /*french*/ "la lame des géants", /*spanish*/ "la daga gigante",
              /*italian*/ "la spada del gigante", /*german*/ "Deutsch" });
    ...
    hintTable[BIGGORON_SWORD] = HintText::Item(
        ...
        Text{ "the Biggoron Sword", /*french*/ "l'épée de Grogoron", /*spanish*/ "la Espada de Biggoron",
              /*italian*/ "la spada di Grande Goron", /*german*/ "Deutsch" });
    ...
    hintTable[DEKU_SHIELD] = HintText::Item(
        ...
        Text{ "a Deku Shield", /*french*/ "un bouclier Mojo", /*spanish*/ "un escudo deku",
              /*italian*/ "uno scudo Deku", /*german*/ "Deutsch" });
    ...
    hintTable[HYLIAN_SHIELD] = HintText::Item(
        ...
        Text{ "a Hylian Shield", /*french*/ "un bouclier hylien", /*spanish*/ "un escudo hyliano",
              /*italian*/ "uno scudo Hylia", /*german*/ "Deutsch" });
    ...
    hintTable[MIRROR_SHIELD] = HintText::Item(
        ...
        Text{ "the Mirror Shield", /*french*/ "le bouclier miroir", /*spanish*/ "el escudo espejo",
              /*italian*/ "lo scudo specchio", /*german*/ "Deutsch" });
    ...
    hintTable[GORON_TUNIC] = HintText::Item(
        ...
        Text{ "a Goron Tunic", /*french*/ "une tunique Goron", /*spanish*/ "un sayo goron",
              /*italian*/ "una veste dei Goron", /*german*/ "Deutsch" });
    ...
    hintTable[ZORA_TUNIC] = HintText::Item(
        ...
        Text{ "a Zora Tunic", /*french*/ "une tunique Zora", /*spanish*/ "un sayo zora",
              /*italian*/ "una veste degli Zora", /*german*/ "Deutsch" });
    ...
    hintTable[IRON_BOOTS] = HintText::Item(
        ...
        Text{ "the Iron Boots", /*french*/ "une paire de bottes de plomb", /*spanish*/ "las botas de hierro",
              /*italian*/ "gli stivali di ferro", /*german*/ "Deutsch" });
    ...
    hintTable[HOVER_BOOTS] = HintText::Item(
        ...
        Text{ "the Hover Boots", /*french*/ "une paire de bottes des airs", /*spanish*/ "las botas voladoras",
              /*italian*/ "gli stivali alati", /*german*/ "Deutsch" });
    ...
    hintTable[ZELDAS_LETTER] = HintText::Item(
        ...
        Text{ "Zelda's Letter", /*french*/ "la Lettre de Zelda", /*spanish*/ "la carta de Zelda",
              /*italian*/ "la lettera di Zelda", /*german*/ "Deutsch" });
    ...
    hintTable[WEIRD_EGG] = HintText::Item(
        ...
        Text{ "the Weird Egg", /*french*/ "l'œuf curieux", /*spanish*/ "el huevo extraño",
              /*italian*/ "l'uovo misterioso", /*german*/ "Deutsch" });
    ...
    hintTable[BOOMERANG] = HintText::Item(
        ...
        // clear text
        Text{ "the Boomerang", /*french*/ "le boomerang", /*spanish*/ "el bumerán", /*italian*/ "il boomerang",
              /*german*/ "Deutsch" });
    ...
    hintTable[LENS_OF_TRUTH] = HintText::Item(
        ...
        Text{ "the Lens of Truth", /*french*/ "le monocle de Vérité", /*spanish*/ "la Lupa de la Verdad",
              /*italian*/ "la lente della verità", /*german*/ "Deutsch" });
    ...
    hintTable[MEGATON_HAMMER] = HintText::Item(
        ...
        Text{ "the Megaton Hammer", /*french*/ "la masse des titans", /*spanish*/ "el martillo Megatón",
              /*italian*/ "il martello megaton", /*german*/ "Deutsch" });
    ...
    hintTable[SHARD_OF_AGONY] = HintText::Item(
        ...
        Text{ "the Shard of Agony", /*french*/ "le fragment de souffrance", /*spanish*/ "la Piedra de la Agonía",
              /*italian*/ "il cristallo sonoro", /*german*/ "Deutsch" });
    ...
    hintTable[DINS_FIRE] = HintText::Item(
        ...
        // clear text
        Text{ "Din's Fire", /*french*/ "le feu de Din", /*spanish*/ "el Fuego de Din", /*italian*/ "il fuoco di Din",
              /*german*/ "Deutsch" });
    ...
    hintTable[FARORES_WIND] = HintText::Item(
        ...
        Text{ "Farore's Wind", /*french*/ "le vent de Farore", /*spanish*/ "el Viento de Farore",
              /*italian*/ "il vento di Farore", /*german*/ "Deutsch" });
    ...
    hintTable[NAYRUS_LOVE] = HintText::Item(
        ...
        Text{ "Nayru's Love", /*french*/ "l'amour de Nayru", /*spanish*/ "el Amor de Nayru",
              /*italian*/ "l'amore di Nayru", /*german*/ "Deutsch" });
    ...
    hintTable[FIRE_ARROWS] = HintText::Item(
        ...
        Text{ "the Fire Arrows", /*french*/ "la flèche de feu", /*spanish*/ "la flecha de fuego",
              /*italian*/ "la freccia di fuoco", /*german*/ "Deutsch" });
    ...
    hintTable[ICE_ARROWS] = HintText::Item(
        ...
        Text{ "the Ice Arrows", /*french*/ "la flèche de glace", /*spanish*/ "la flecha de hielo",
              /*italian*/ "la freccia di ghiaccio", /*german*/ "Deutsch" });
    ...
    hintTable[LIGHT_ARROWS] = HintText::Item(
        ...
        Text{ "the Light Arrows", /*french*/ "la flèche de lumière", /*spanish*/ "la flecha de luz",
              /*italian*/ "la freccia di luce", /*german*/ "Deutsch" });
    ...
    hintTable[GERUDO_TOKEN] = HintText::Item(
        ...
        Text{ "the Gerudo Token", /*french*/ "la carte Gerudo", /*spanish*/ "el pase de socio gerudo",
              /*italian*/ "la Gerudo Card", /*german*/ "Deutsch" });
    ...
    hintTable[MAGIC_BEAN] = HintText::Item(
        ...
        Text{ "a Magic Bean", /*french*/ "un haricot magique", /*spanish*/ "una judía mágica",
              /*italian*/ "un fagiolo magico", /*german*/ "Deutsch" });
    ...
    hintTable[MAGIC_BEAN_PACK] = HintText::Item(
        ...
        Text{ "Magic Beans", /*french*/ "un paquet de haricots magiques", /*spanish*/ "unas judías mágicas",
              /*italian*/ "un pacco di fagioli magici", /*german*/ "Deutsch" });
    ...
    hintTable[GOLD_SKULLTULA_TOKEN] = HintText::Item(
        ...
        // clear text
        Text{ "a Gold Skulltula Token", /*french*/ "un jeton de Skulltula d'or",
              /*spanish*/ "un símbolo de skulltula dorada", /*italian*/ "un teschio d'oro", /*german*/ "Deutsch" });
    ...
    hintTable[POCKET_EGG] = HintText::Item(
        ...
        Text{ "the Pocket Egg", /*french*/ "l'œuf de poche", /*spanish*/ "el huevo de bolsillo",
              /*italian*/ "l'uovo tascabile", /*german*/ "Deutsch" });
    ...
    hintTable[POCKET_CUCCO] = HintText::Item(
        ...
        Text{ "the Pocket Cucco", /*french*/ "le Cocotte de poche", /*spanish*/ "el cuco de bolsillo",
              /*italian*/ "il coccò tascabile", /*german*/ "Deutsch" });
    ...
    hintTable[COJIRO] = HintText::Item(
        ...
        // clear text
        Text{ "Cojiro", /*french*/ "le p'tit poulet", /*spanish*/ "a Cojiro", /*italian*/ "Coblù",
              /*german*/ "Deutsch" });
    ...
    hintTable[ODD_MUSHROOM] = HintText::Item(
        ...
        Text{ "an Odd Mushroom", /*french*/ "un champignon suspect", /*spanish*/ "un champiñón extraño",
              /*italian*/ "un fungo strano", /*german*/ "Deutsch" });
    ...
    hintTable[ODD_POULTICE] = HintText::Item(
        ...
        Text{ "an Odd Poultice", /*french*/ "une mixture suspecte", /*spanish*/ "una medicina rara",
              /*italian*/ "una medicina strana", /*german*/ "Deutsch" });
    ...
    hintTable[POACHERS_SAW] = HintText::Item(
        ...
        Text{ "the Poacher's Saw", /*french*/ "la scie du chasseur", /*spanish*/ "la sierra del furtivo",
              /*italian*/ "la sega del bracconiere", /*german*/ "Deutsch" });
    ...
    hintTable[BROKEN_SWORD] = HintText::Item(
        ...
        Text{ "the Broken Goron's Sword", /*french*/ "l'épée brisée de Goron", /*spanish*/ "la espada goron rota",
              /*italian*/ "la spada rotta dei Goron", /*german*/ "Deutsch" });
    ...
    hintTable[PRESCRIPTION] = HintText::Item(
        ...
        // clear text
        Text{ "the Prescription", /*french*/ "une ordonnance", /*spanish*/ "la receta", /*italian*/ "la ricetta",
              /*german*/ "Deutsch" });
    ...
    hintTable[EYEBALL_FROG] = HintText::Item(
        ...
        Text{ "the Eyeball Frog", /*french*/ "le crapaud-qui-louche", /*spanish*/ "la rana de ojos saltones",
              /*italian*/ "la rana occhiuta", /*german*/ "Deutsch" });
    ...
    hintTable[EYEDROPS] = HintText::Item(
        ...
        Text{ "the Eyedrops", /*french*/ "une phiole de super gouttes", /*spanish*/ "las supergotas oculares",
              /*italian*/ "il miglior collirio del mondo", /*german*/ "Deutsch" });
    ...
    hintTable[CLAIM_CHECK] = HintText::Item(
        ...
        // clear text
        Text{ "the Claim Check", /*french*/ "un certificat", /*spanish*/ "el recibo", /*italian*/ "il buono",
              /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_HOOKSHOT] = HintText::Item(
        ...
        // clear text
        Text{ "a Hookshot", /*french*/ "un grappin", /*spanish*/ "un gancho", /*italian*/ "un arpione",
              /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_STRENGTH] = HintText::Item(
        ...
        Text{ "a Strength Upgrade", /*french*/ "une amélioration de force", /*spanish*/ "un aumento de fuerza",
              /*italian*/ "un potenziamento di forza", /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_BOMB_BAG] = HintText::Item(
        ...
        // clear text
        Text{ "a Bomb Bag", /*french*/ "un sac de bombes", /*spanish*/ "un saco de bombas", /*italian*/ "un portabombe",
              /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_BOW] = HintText::Item(
        ...
        // clear text
        Text{ "a Bow", /*french*/ "l'arc des fées", /*spanish*/ "un arco de las hadas", /*italian*/ "un arco",
              /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_SLINGSHOT] = HintText::Item(
        ...
        Text{ "a Slingshot", /*french*/ "un lance-pierre", /*spanish*/ "una resortera de las hadas",
              /*italian*/ "una fionda", /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_WALLET] = HintText::Item(
        ...
        // clear text
        Text{ "a Wallet", /*french*/ "une bourse", /*spanish*/ "una bolsa de rupias", /*italian*/ "un portarupie",
              /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_SCALE] = HintText::Item(
        ...
        Text{ "a Zora Scale", /*french*/ "une écaille Zora", /*spanish*/ "una escama Zora",
              /*italian*/ "una squama Zora", /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_NUT_UPGRADE] = HintText::Item(
        ...
        Text{ "Deku Nut Capacity", /*french*/ "une augmentation de noix Mojo", /*spanish*/ "un aumento de nueces deku",
              /*italian*/ "una maggiore capacità di noci Deku", /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_STICK_UPGRADE] = HintText::Item(
        ...
        Text{ "Deku Stick Capacity", /*french*/ "une augmentation de bâtons Mojo",
              /*spanish*/ "un aumento de palos deku", /*italian*/ "una maggiore capacità di rami Deku",
              /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_MAGIC_METER] = HintText::Item(
        ...
        Text{ "a Magic Meter", /*french*/ "une jauge de magie", /*spanish*/ "un aumento de poder mágico",
              /*italian*/ "una barra della magia", /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_OCARINA] = HintText::Item(
        ...
        // clear text
        Text{ "an Ocarina", /*french*/ "un ocarina", /*spanish*/ "una ocarina", /*italian*/ "un'ocarina",
              /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_BOMBCHUS] = HintText::Item(
        ...
        Text{ "Bombchus", /*french*/ "un paquet de Bombchus", /*spanish*/ "unos bombchus",
              /*italian*/ "alcune radiomine", /*german*/ "Deutsch" });
    ...
    hintTable[PROGRESSIVE_GORONSWORD] = HintText::Item(
        ...
        Text{ "a Goron Sword", /*french*/ "une épée Goron", /*spanish*/ "una espada goron",
              /*italian*/ "una spada Goron", /*german*/ "Deutsch" });
    ...
    hintTable[EMPTY_BOTTLE] = HintText::Item(
        ...
        // clear text
        Text{ "a Bottle", /*french*/ "un flacon vide", /*spanish*/ "una botella", /*italian*/ "un'ampolla",
              /*german*/ "Deutsch" });
    ...
    hintTable[BOTTLE_WITH_MILK] = HintText::Item(
        ...
        Text{ "a Milk Bottle", /*french*/ "un flacon de lait", /*spanish*/ "una botella de leche",
              /*italian*/ "un'ampolla di latte", /*german*/ "Deutsch" });
    ...
    hintTable[BOTTLE_WITH_RED_POTION] = HintText::Item(
        ...
        Text{ "a Red Potion Bottle", /*french*/ "un flacon de potion rouge", /*spanish*/ "una botella de poción roja",
              /*italian*/ "un'ampolla di pozione vita", /*german*/ "Deutsch" });
    ...
    hintTable[BOTTLE_WITH_GREEN_POTION] = HintText::Item(
        ...
        Text{ "a Green Potion Bottle", /*french*/ "un flacon de potion verte",
              /*spanish*/ "una botella de poción verde", /*italian*/ "un'ampolla di pozione magica",
              /*german*/ "Deutsch" });
    ...
    hintTable[BOTTLE_WITH_BLUE_POTION] = HintText::Item(
        ...
        Text{ "a Blue Potion Bottle", /*french*/ "un flacon de potion bleue", /*spanish*/ "una botella de poción azul",
              /*italian*/ "un'ampolla di pozione curatutto", /*german*/ "Deutsch" });
    ...
    hintTable[BOTTLE_WITH_FAIRY] = HintText::Item(
        ...
        Text{ "a Fairy Bottle", /*french*/ "une fée en flacon", /*spanish*/ "un hada en una botella",
              /*italian*/ "una fata in un'ampolla", /*german*/ "Deutsch" });
    ...
    hintTable[BOTTLE_WITH_FISH] = HintText::Item(
        ...
        Text{ "a Fish Bottle", /*french*/ "un poisson en flacon", /*spanish*/ "un pez en una botella",
              /*italian*/ "un pesce in un'ampolla", /*german*/ "Deutsch" });
    ...
    hintTable[BOTTLE_WITH_BLUE_FIRE] = HintText::Item(
        ...
        Text{ "a Blue Fire Bottle", /*french*/ "une flamme bleue en flacon", /*spanish*/ "una botella de fuego azul",
              /*italian*/ "un'ampolla di fuoco blu", /*german*/ "Deutsch" });
    ...
    hintTable[BOTTLE_WITH_BUGS] = HintText::Item(
        ...
        Text{ "a Bug Bottle", /*french*/ "un insecte en flacon", /*spanish*/ "unos insectos en una botella",
              /*italian*/ "un insetto in un'ampolla", /*german*/ "Deutsch" });
    ...
    hintTable[BOTTLE_WITH_POE] = HintText::Item(
        ...
        Text{ "a Poe Bottle", /*french*/ "un Esprit en flacon", /*spanish*/ "un Poe en una botella",
              /*italian*/ "un Poo in un'ampolla", /*german*/ "Deutsch" });
    ...
    hintTable[BOTTLE_WITH_BIG_POE] = HintText::Item(
        ...
        Text{ "a Big Poe Bottle", /*french*/ "une Ame en flacon", /*spanish*/ "un Gran Poe en una botella",
              /*italian*/ "un Grande Poo in un'ampolla", /*german*/ "Deutsch" });
    ...
    hintTable[RUTOS_LETTER] = HintText::Item(
        ...
        Text{ "Ruto's Letter", /*french*/ "la lettre de Ruto", /*spanish*/ "la carta de Ruto",
              /*italian*/ "una lettera in un'ampolla", /*german*/ "Deutsch" });
    ...
    hintTable[ZELDAS_LULLABY] = HintText::Item(
        ...
        Text{ "Zelda's Lullaby", /*french*/ "la berceuse de Zelda", /*spanish*/ "la Nana de Zelda",
              /*italian*/ "la ninna nanna di Zelda", /*german*/ "Deutsch" });
    ...
    hintTable[EPONAS_SONG] = HintText::Item(
        ...
        Text{ "Epona's Song", /*french*/ "le chant d'Epona", /*spanish*/ "la Canción de Epona",
              /*italian*/ "la canzone di Epona", /*german*/ "Deutsch" });
    ...
    hintTable[SARIAS_SONG] = HintText::Item(
        ...
        Text{ "Saria's Song", /*french*/ "le chant de Saria", /*spanish*/ "la Canción de Saria",
              /*italian*/ "la canzone di Saria", /*german*/ "Deutsch" });
    ...
    hintTable[SUNS_SONG] = HintText::Item(
        ...
        Text{ "the Sun's Song", /*french*/ "le chant du soleil", /*spanish*/ "la Canción del Sol",
              /*italian*/ "il canto del sole", /*german*/ "Deutsch" });
    ...
    hintTable[SONG_OF_TIME] = HintText::Item(
        ...
        Text{ "the Song of Time", /*french*/ "le chant du temps", /*spanish*/ "la Canción del tiempo",
              /*italian*/ "la canzone del tempo", /*german*/ "Deutsch" });
    ...
    hintTable[SONG_OF_STORMS] = HintText::Item(
        ...
        Text{ "the Song of Storms", /*french*/ "le chant des tempêtes", /*spanish*/ "la Canción de la Tormenta",
              /*italian*/ "la canzone della tempesta", /*german*/ "Deutsch" });
    ...
    hintTable[MINUET_OF_FOREST] = HintText::Item(
        ...
        Text{ "the Minuet of Forest", /*french*/ "le menuet de la forêt", /*spanish*/ "el Minueto del bosque",
              /*italian*/ "il minuetto della foresta", /*german*/ "Deutsch" });
    ...
    hintTable[BOLERO_OF_FIRE] = HintText::Item(
        ...
        Text{ "the Bolero of Fire", /*french*/ "le boléro du feu", /*spanish*/ "el Bolero del fuego",
              /*italian*/ "il bolero del fuoco", /*german*/ "Deutsch" });
    ...
    hintTable[SERENADE_OF_WATER] = HintText::Item(
        ...
        Text{ "the Serenade of Water", /*french*/ "la sérénade de l'eau", /*spanish*/ "la Serenata del agua",
              /*italian*/ "la serenata dell'acqua", /*german*/ "Deutsch" });
    ...
    hintTable[REQUIEM_OF_SPIRIT] = HintText::Item(
        ...
        Text{ "the Requiem of Spirit", /*french*/ "le requiem des esprits", /*spanish*/ "el Réquiem del espíritu",
              /*italian*/ "il requiem dello spirito", /*german*/ "Deutsch" });
    ...
    hintTable[NOCTURNE_OF_SHADOW] = HintText::Item(
        ...
        Text{ "the Nocturne of Shadow", /*french*/ "le nocturne de l'ombre", /*spanish*/ "el Nocturno de la sombra",
              /*italian*/ "il notturno delle ombre", /*german*/ "Deutsch" });
    ...
    hintTable[PRELUDE_OF_LIGHT] = HintText::Item(
        ...
        Text{ "the Prelude of Light", /*french*/ "le prélude de la lumière", /*spanish*/ "el Preludio de la luz",
              /*italian*/ "il preludio della luce", /*german*/ "Deutsch" });
    hintTable[DEKU_TREE_MAP] = HintText::Item(
        ...
        Text{ "the Deku Tree Map", /*french*/ "la carte de l'arbre Mojo", /*spanish*/ "el mapa del Gran Árbol Deku",
              /*italian*/ "la mappa del Grande Albero Deku", /*german*/ "Deutsch" });
    hintTable[DODONGOS_CAVERN_MAP] = HintText::Item(
        ...
        Text{ "the Dodongo's Cavern Map", /*french*/ "la carte de la caverne Dodongo",
              /*spanish*/ "el mapa de la Cueva de los Dodongos", /*italian*/ "la mappa della caverna dei Dodongo",
              /*german*/ "Deutsch" });
    hintTable[JABU_JABUS_BELLY_MAP] = HintText::Item(
        ...
        Text{ "the Jabu-Jabu's Belly Map", /*french*/ "la carte de Jabu-Jabu",
              /*spanish*/ "el mapa de la Tripa de Jabu-Jabu", /*italian*/ "la mappa della pancia di Jabu Jabu",
              /*german*/ "Deutsch" });
    hintTable[FOREST_TEMPLE_MAP] = HintText::Item(
        ...
        Text{ "the Forest Temple Map", /*french*/ "la carte du temple de la forêt",
              /*spanish*/ "el mapa del Templo del Bosque", /*italian*/ "la mappa del Santuario della Foresta",
              /*german*/ "Deutsch" });
    hintTable[FIRE_TEMPLE_MAP] = HintText::Item(
        ...
        Text{ "the Fire Temple Map", /*french*/ "la carte du temple du feu", /*spanish*/ "el mapa del Templo del Fuego",
              /*italian*/ "la mappa del Santuario del Fuoco", /*german*/ "Deutsch" });
    hintTable[WATER_TEMPLE_MAP] = HintText::Item(
        ...
        Text{ "the Water Temple Map", /*french*/ "la carte du temple de l'eau",
              /*spanish*/ "el mapa del Templo del Agua", /*italian*/ "la mappa del Santuario dell'Acqua",
              /*german*/ "Deutsch" });
    hintTable[SPIRIT_TEMPLE_MAP] = HintText::Item(
        ...
        Text{ "the Spirit Temple Map", /*french*/ "la carte du temple de l'esprit",
              /*spanish*/ "el mapa del Templo del Espíritu", /*italian*/ "la mappa del Santuario dello Spirito",
              /*german*/ "Deutsch" });
    hintTable[SHADOW_TEMPLE_MAP] = HintText::Item(
        ...
        Text{ "the Shadow Temple Map", /*french*/ "la carte du temple de l'ombre",
              /*spanish*/ "el mapa del Templo de las Sombras", /*italian*/ "la mappa del Santuario dell'Ombra",
              /*german*/ "Deutsch" });
    hintTable[BOTTOM_OF_THE_WELL_MAP] = HintText::Item(
        ...
        Text{ "the Bottom of the Well Map", /*french*/ "la carte du fond du puits",
              /*spanish*/ "el mapa del Fondo del pozo", /*italian*/ "la mappa del fondo del pozzo",
              /*german*/ "Deutsch" });
    hintTable[ICE_CAVERN_MAP] = HintText::Item(
        ...
        Text{ "the Ice Cavern Map", /*french*/ "la carte de la caverne polaire",
              /*spanish*/ "el mapa de la Caverna de hielo", /*italian*/ "la mappa della caverna di ghiaccio",
              /*german*/ "Deutsch" });
    hintTable[DEKU_TREE_COMPASS] = HintText::Item(
        ...
        Text{ "the Deku Tree Compass", /*french*/ "la boussole de l'arbre Mojo",
              /*spanish*/ "la brújula del Gran Árbol Deku", /*italian*/ "la bussola del Grande Albero Deku",
              /*german*/ "Deutsch" });
    hintTable[DODONGOS_CAVERN_COMPASS] = HintText::Item(
        ...
        Text{ "the Dodongo's Cavern Compass", /*french*/ "la boussole de la caverne Dodongo",
              /*spanish*/ "la brújula de la Cueva de los Dodongos", /*italian*/ "la bussola della caverna dei Dodongo",
              /*german*/ "Deutsch" });
    hintTable[JABU_JABUS_BELLY_COMPASS] = HintText::Item(
        ...
        Text{ "the Jabu-Jabu's Belly Compass", /*french*/ "la boussole de Jabu-Jabu",
              /*spanish*/ "la brújula de la Tripa de Jabu-Jabu", /*italian*/ "la bussola della pancia di Jabu Jabu",
              /*german*/ "Deutsch" });
    hintTable[FOREST_TEMPLE_COMPASS] = HintText::Item(
        ...
        Text{ "the Forest Temple Compass", /*french*/ "la boussole du temple de la forêt",
              /*spanish*/ "la brújula del Templo del Bosque", /*italian*/ "la bussola del Santuario della Foresta",
              /*german*/ "Deutsch" });
    hintTable[FIRE_TEMPLE_COMPASS] = HintText::Item(
        ...
        Text{ "the Fire Temple Compass", /*french*/ "la boussole du temple du feu",
              /*spanish*/ "la brújula del Templo del Fuego", /*italian*/ "la bussola del Santuario del Fuoco",
              /*german*/ "Deutsch" });
    hintTable[WATER_TEMPLE_COMPASS] = HintText::Item(
        ...
        Text{ "the Water Temple Compass", /*french*/ "la boussole du temple de l'eau",
              /*spanish*/ "la brújula del Templo del Agua", /*italian*/ "la bussola del Santuario dell'Acqua",
              /*german*/ "Deutsch" });
    hintTable[SPIRIT_TEMPLE_COMPASS] = HintText::Item(
        ...
        Text{ "the Spirit Temple Compass", /*french*/ "la boussole du temple de l'esprit",
              /*spanish*/ "la brújula del Templo del Espíritu", /*italian*/ "la bussola del Santuario dello Spirito",
              /*german*/ "Deutsch" });
    hintTable[SHADOW_TEMPLE_COMPASS] = HintText::Item(
        ...
        Text{ "the Shadow Temple Compass", /*french*/ "la boussole du temple de l'ombre",
              /*spanish*/ "la brújula del Templo de las Sombras", /*italian*/ "la bussola del Santuario dell'Ombra",
              /*german*/ "Deutsch" });
    hintTable[BOTTOM_OF_THE_WELL_COMPASS] = HintText::Item(
        ...
        Text{ "the Bottom of the Well Compass", /*french*/ "la boussole du fond du puits",
              /*spanish*/ "la brújula del Fondo del pozo", /*italian*/ "la bussola del fondo del pozzo",
              /*german*/ "Deutsch" });
    hintTable[ICE_CAVERN_COMPASS] = HintText::Item(
        ...
        Text{ "the Ice Cavern Compass", /*french*/ "la boussole de la caverne polaire",
              /*spanish*/ "la brújula de la Caverna de hielo", /*italian*/ "la bussola della caverna di ghiaccio",
              /*german*/ "Deutsch" });
    hintTable[FOREST_TEMPLE_BOSS_KEY] = HintText::Item(
        ...
        Text{ "the Forest Temple Boss Key", /*french*/ "la clé d'or du temple de la forêt",
              ...
              /*italian*/ "la grande chiave del Santuario della Foresta", /*german*/ "Deutsch" });
    hintTable[FIRE_TEMPLE_BOSS_KEY] = HintText::Item(
        ...
        Text{ "the Fire Temple Boss Key", /*french*/ "la clé d'or du temple du feu",
              /*spanish*/ "la gran llave del Templo del Fuego", /*italian*/ "la grande chiave del Santuario del Fuoco",
              /*german*/ "Deutsch" });
    hintTable[WATER_TEMPLE_BOSS_KEY] = HintText::Item(
        ...
        Text{ "the Water Temple Boss Key", /*french*/ "la clé d'or du temple de l'eau",
              /*spanish*/ "la gran llave del Templo del Agua", /*italian*/ "la grande chiave del Santuario dell'Acqua",
              /*german*/ "Deutsch" });
    hintTable[SPIRIT_TEMPLE_BOSS_KEY] = HintText::Item(
        ...
        Text{ "the Spirit Temple Boss Key", /*french*/ "la clé d'or du temple de l'esprit",
              ...
              /*italian*/ "la grande chiave del Santuario dello Spirito", /*german*/ "Deutsch" });
    hintTable[SHADOW_TEMPLE_BOSS_KEY] = HintText::Item(
        ...
        Text{ "the Shadow Temple Boss Key", /*french*/ "la clé d'or du temple de l'ombre",
              ...
              /*italian*/ "la grande chiave del Santuario dell'Ombra", /*german*/ "Deutsch" });
    hintTable[GANONS_CASTLE_BOSS_KEY] = HintText::Item(
        ...
        Text{ "the Ganon's Castle Boss Key", /*french*/ "la clé d'or du château de Ganon",
              /*spanish*/ "la gran llave del Castillo de Ganon", /*italian*/ "la grande chiave del castello di Ganon",
              /*german*/ "Deutsch" });
    hintTable[FOREST_TEMPLE_SMALL_KEY] = HintText::Item(
        ...
        Text{ "a Forest Temple Small Key", /*french*/ "une petite clé du temple de la forêt",
              ...
              /*italian*/ "una piccola chiave del Santuario della Foresta", /*german*/ "Deutsch" });
    hintTable[FIRE_TEMPLE_SMALL_KEY] = HintText::Item(
        ...
        Text{ "a Fire Temple Small Key", /*french*/ "une petite clé du temple du feu",
              ...
              /*italian*/ "una piccola chiave del Santuario del Fuoco", /*german*/ "Deutsch" });
    hintTable[WATER_TEMPLE_SMALL_KEY] = HintText::Item(
        ...
        Text{ "a Water Temple Small Key", /*french*/ "une petite clé du temple de l'eau",
              ...
              /*italian*/ "una piccola chiave del Santuario dell'Acqua", /*german*/ "Deutsch" });
    hintTable[SPIRIT_TEMPLE_SMALL_KEY] = HintText::Item(
        ...
        Text{ "a Spirit Temple Small Key", /*french*/ "une petite clé du temple de l'esprit",
              ...
              /*italian*/ "una piccola chiave del Santuario dello Spirito", /*german*/ "Deutsch" });
    hintTable[SHADOW_TEMPLE_SMALL_KEY] = HintText::Item(
        ...
        Text{ "a Shadow Temple Small Key", /*french*/ "une petite clé du temple de l'ombre",
              ...
              /*italian*/ "una piccola chiave del Santuario dell'Ombra", /*german*/ "Deutsch" });
    hintTable[GERUDO_TRAINING_GROUNDS_SMALL_KEY] = HintText::Item(
        ...
        Text{ "a Gerudo Training Ground Small Key", /*french*/ "une petite clé du gymnase Gerudo",
              ...
              /*italian*/ "una piccola chiave della zona di addestramento Gerudo", /*german*/ "Deutsch" });
    hintTable[GERUDO_FORTRESS_SMALL_KEY] = HintText::Item(
        ...
        // clear text
        Text{ "a Gerudo Fortress Small Key", /*french*/ "une petite clé de la forteresse Gerudo",
              /*spanish*/ "una llave pequeña de la Fortaleza Gerudo",
              /*italian*/ "una piccola chiave della fortezza Gerudo", /*german*/ "Deutsch" });
    hintTable[BOTTOM_OF_THE_WELL_SMALL_KEY] = HintText::Item(
        ...
        Text{ "a Bottom of the Well Small Key", /*french*/ "une petite clé du fond du puits",
              /*spanish*/ "una llave pequeña del Fondo del pozo", /*italian*/ "una piccola chiave del fondo del pozzo",
              /*german*/ "Deutsch" });
    hintTable[GANONS_CASTLE_SMALL_KEY] = HintText::Item(
        ...
        Text{ "a Ganon's Castle Small Key", /*french*/ "une petite clé du château de Ganon",
              ...
              /*italian*/ "una piccola chiave del castello di Ganon", /*german*/ "Deutsch" });
    hintTable[FOREST_TEMPLE_KEY_RING] = HintText::Item(
        ...
        Text{ "a Forest Temple Key Ring", /*french*/ "un trousseau de clés du temple de la forêt",
              ...
              /*italian*/ "un mazzo di chiavi del Santuario della Foresta", /*german*/ "Deutsch" });
    hintTable[FIRE_TEMPLE_KEY_RING] = HintText::Item(
        ...
        Text{ "a Fire Temple Key Ring", /*french*/ "un trousseau de clés du temple du feu",
              /*spanish*/ "un llavero del Templo del Fuego", /*italian*/ "un mazzo di chiavi del Santuario del Fuoco",
              /*german*/ "Deutsch" });
    hintTable[WATER_TEMPLE_KEY_RING] = HintText::Item(
        ...
        Text{ "a Water Temple Key Ring", /*french*/ "un trousseau de clés du temple de l'eau",
              /*spanish*/ "un llavero del Templo del Agua", /*italian*/ "un mazzo di chiavi del Santuario dell'Acqua",
              /*german*/ "Deutsch" });
    hintTable[SPIRIT_TEMPLE_KEY_RING] = HintText::Item(
        ...
        Text{ "a Spirit Temple Key Ring", /*french*/ "un trousseau de clés du temple de l'esprit",
              ...
              /*italian*/ "un mazzo di chiavi del Santuario dello Spirito", /*german*/ "Deutsch" });
    hintTable[SHADOW_TEMPLE_KEY_RING] = HintText::Item(
        ...
        Text{ "a Shadow Temple Key Ring", /*french*/ "un trousseau de clés du temple de l'ombre",
              ...
              /*italian*/ "un mazzo di chiavi del Santuario dell'Ombra", /*german*/ "Deutsch" });
    hintTable[GERUDO_TRAINING_GROUNDS_KEY_RING] = HintText::Item(
        ...
        Text{ "a Gerudo Training Ground Key Ring", /*french*/ "un trousseau de clés du gymnase Gerudo",
              ...
              /*italian*/ "un mazzo di chiavi della zona di addestramento", /*german*/ "Deutsch" });
    hintTable[GERUDO_FORTRESS_KEY_RING] = HintText::Item(
        ...
        // clear text
        Text{ "a Gerudo Fortress Key Ring", /*french*/ "un trousseau de clés de la forteresse Gerudo",
              /*spanish*/ "un llavero de la Fortaleza Gerudo", /*italian*/ "un mazzo di chiavi della fortezza Gerudo",
              /*german*/ "Deutsch" });
    hintTable[BOTTOM_OF_THE_WELL_KEY_RING] = HintText::Item(
        ...
        Text{ "a Bottom of the Well Key Ring", /*french*/ "un trousseau de clés du fond du puits",
              /*spanish*/ "un llavero del Fondo del pozo", /*italian*/ "un mazzo di chiavi del fondo del pozzo",
              /*german*/ "Deutsch" });
    hintTable[GANONS_CASTLE_KEY_RING] = HintText::Item(
        ...
        Text{ "a Ganon's Castle Key Ring", /*french*/ "un trousseau de clés du château de Ganon",
              /*spanish*/ "un llavero del Castillo de Ganon", /*italian*/ "un mazzo di chiavi del castello di Ganon",
              /*german*/ "Deutsch" });
    ...
    hintTable[TREASURE_GAME_SMALL_KEY] = HintText::Item(
        ...
        Text{ "a Treasure Chest Shop Small Key", /*french*/ "une petite clé de la chasse aux trésors",
              ...
              /*italian*/ "una piccola chiave della sala della fortuna", /*german*/ "Deutsch" });
    ...
    hintTable[KOKIRI_EMERALD] = HintText::Item(
        ...
        Text{ "the Kokiri Emerald", /*french*/ "l'émeraude Kokiri", /*spanish*/ "la Esmeralda de los Kokiri",
              /*italian*/ "lo smeraldo dei Kokiri", /*german*/ "Deutsch" });
    ...
    hintTable[GORON_RUBY] = HintText::Item(
        ...
        Text{ "the Goron Ruby", /*french*/ "le rubis Goron", /*spanish*/ "el Rubí de los Goron",
              /*italian*/ "il rubino dei Goron", /*german*/ "Deutsch" });
    ...
    hintTable[ZORA_SAPPHIRE] = HintText::Item(
        ...
        Text{ "the Zora Sapphire", /*french*/ "le saphir Zora", /*spanish*/ "el Zafiro de los Zora",
              /*italian*/ "lo zaffiro degli Zora", /*german*/ "Deutsch" });
    ...
    hintTable[FOREST_MEDALLION] = HintText::Item(
        ...
        Text{ "the Forest Medallion", /*french*/ "le médaillon de la forêt", /*spanish*/ "el Medallón del Bosque",
              /*italian*/ "il medaglione della Foresta", /*german*/ "Deutsch" });
    ...
    hintTable[FIRE_MEDALLION] = HintText::Item(
        ...
        Text{ "the Fire Medallion", /*french*/ "le médaillon du feu", /*spanish*/ "el Medallón del Fuego",
              /*italian*/ "il medaglione del Fuoco", /*german*/ "Deutsch" });
    ...
    hintTable[WATER_MEDALLION] = HintText::Item(
        ...
        Text{ "the Water Medallion", /*french*/ "le médaillon de l'eau", /*spanish*/ "el Medallón del Agua",
              /*italian*/ "il medaglione dell'Acqua", /*german*/ "Deutsch" });
    ...
    hintTable[SPIRIT_MEDALLION] = HintText::Item(
        ...
        Text{ "the Spirit Medallion", /*french*/ "le médaillon de l'esprit", /*spanish*/ "el Medallón del Espíritu",
              /*italian*/ "il medaglione dello Spirito", /*german*/ "Deutsch" });
    ...
    hintTable[SHADOW_MEDALLION] = HintText::Item(
        ...
        Text{ "the Shadow Medallion", /*french*/ "le médaillon de l'ombre", /*spanish*/ "el Medallón de la Sombra",
              /*italian*/ "il medaglione dell'Ombra", /*german*/ "Deutsch" });
    ...
    hintTable[LIGHT_MEDALLION] = HintText::Item(
        ...
        Text{ "the Light Medallion", /*french*/ "le médaillon de la lumière", /*spanish*/ "el Medallón de la Luz",
              /*italian*/ "il medaglione della Luce", /*german*/ "Deutsch" });
    ...
    hintTable[RECOVERY_HEART] = HintText::Item(
        ...
        // clear text
        Text{ "a Recovery Heart", /*french*/ "un cœur de vie", /*spanish*/ "un corazón", /*italian*/ "un cuore",
              /*german*/ "Deutsch" });
    ...
    hintTable[GREEN_RUPEE] = HintText::Item(
        ...
        // clear text
        Text{ "a Green Rupee", /*french*/ "un rubis vert", /*spanish*/ "una rupia verde", /*italian*/ "una rupia verde",
              /*german*/ "Deutsch" });
    ...
    hintTable[BLUE_RUPEE] = HintText::Item(
        ...
        // clear text
        Text{ "a Blue Rupee", /*french*/ "un rubis bleu", /*spanish*/ "una rupia azul", /*italian*/ "una rupia blu",
              /*german*/ "Deutsch" });
    ...
    hintTable[RED_RUPEE] = HintText::Item(
        ...
        // clear text
        Text{ "a Red Rupee", /*french*/ "un rubis rouge", /*spanish*/ "una rupia roja", /*italian*/ "una rupia rossa",
              /*german*/ "Deutsch" });
    ...
    hintTable[PURPLE_RUPEE] = HintText::Item(
        ...
        Text{ "a Purple Rupee", /*french*/ "un rubis pourpre", /*spanish*/ "una rupia morada",
              /*italian*/ "una rupia viola", /*german*/ "Deutsch" });
    ...
    hintTable[HUGE_RUPEE] = HintText::Item(
        ...
        Text{ "a Huge Rupee", /*french*/ "un énorme rubis", /*spanish*/ "una rupia gigante",
              /*italian*/ "una rupia gigante", /*german*/ "Deutsch" });
    ...
    hintTable[PIECE_OF_HEART] = HintText::Item(
        ...
        Text{ "a Piece of Heart", /*french*/ "un quart de cœur", /*spanish*/ "una pieza de corazón",
              /*italian*/ "un frammento di cuore", /*german*/ "Deutsch" });
    ...
    hintTable[HEART_CONTAINER] = HintText::Item(
        ...
        Text{ "a Heart Container", /*french*/ "un cœur d'énergie", /*spanish*/ "un contenedor de corazón",
              /*italian*/ "un portacuori", /*german*/ "Deutsch" });
    ...
    hintTable[ICE_TRAP] = HintText::Item(
        ...
        Text{ "an Ice Trap", /*french*/ "un piège de glace", /*spanish*/ "una trampa de hielo",
              /*italian*/ "una trappola di ghiaccio", /*german*/ "Deutsch" });
    ...
    hintTable[BOMBS_5] = HintText::Item(
        ...
        Text{ "Bombs (5 pieces)", /*french*/ "une demi-dizaine de bombes", /*spanish*/ "unas (5) bombas",
              /*italian*/ "5 bombe", /*german*/ "Deutsch" });
    ...
    hintTable[BOMBS_10] = HintText::Item(
        ...
        Text{ "Bombs (10 pieces)", /*french*/ "une dizaine de bombes", /*spanish*/ "unas (10) bombas",
              /*italian*/ "10 bombe", /*german*/ "Deutsch" });
    ...
    hintTable[BOMBS_20] = HintText::Item(
        ...
        Text{ "Bombs (20 pieces)", /*french*/ "une vingtaine de bombes", /*spanish*/ "unas (20) bombas",
              /*italian*/ "20 bombe", /*german*/ "Deutsch" });
    ...
    hintTable[BOMBCHU_5] = HintText::Item(
        ...
        Text{ "Bombchus (5 pieces)", /*french*/ "une demi-dizaine de Bombchus", /*spanish*/ "unos (5) bombchus",
              /*italian*/ "5 radiomine", /*german*/ "Deutsch" });
    ...
    hintTable[BOMBCHU_10] = HintText::Item(
        ...
        Text{ "Bombchus (10 pieces)", /*french*/ "une dizaine de Bombchus", /*spanish*/ "unos (10) bombchus",
              /*italian*/ "10 radiomine", /*german*/ "Deutsch" });
    ...
    hintTable[BOMBCHU_20] = HintText::Item(
        ...
        Text{ "Bombchus (20 pieces)", /*french*/ "une vingtaine de Bombchus", /*spanish*/ "unos (20) bombchus",
              /*italian*/ "20 radiomine", /*german*/ "Deutsch" });
    ...
    hintTable[ARROWS_5] = HintText::Item(
        ...
        Text{ "Arrows (5 pieces)", /*french*/ "une demi-dizaine de flèches", /*spanish*/ "unas (5) flechas",
              /*italian*/ "5 frecce", /*german*/ "Deutsch" });
    ...
    hintTable[ARROWS_10] = HintText::Item(
        ...
        Text{ "Arrows (10 pieces)", /*french*/ "une dizaine de flèches", /*spanish*/ "unas (10) flechas",
              /*italian*/ "10 frecce", /*german*/ "Deutsch" });
    ...
    hintTable[ARROWS_30] = HintText::Item(
        ...
        Text{ "Arrows (30 pieces)", /*french*/ "une trentaine de flèches", /*spanish*/ "unas (30) flechas",
              /*italian*/ "30 frecce", /*german*/ "Deutsch" });
    ...
    hintTable[DEKU_NUTS_5] = HintText::Item(
        ...
        Text{ "Deku Nuts (5 pieces)", /*french*/ "une demi-dizaine de noix Mojo", /*spanish*/ "unas (5) nueces deku",
              /*italian*/ "5 noci Deku", /*german*/ "Deutsch" });
    ...
    hintTable[DEKU_NUTS_10] = HintText::Item(
        ...
        Text{ "Deku Nuts (10 pieces)", /*french*/ "une dizaine de noix Mojo", /*spanish*/ "unas (10) nueces deku",
              /*italian*/ "10 noci Deku", /*german*/ "Deutsch" });
    ...
    hintTable[DEKU_SEEDS_30] = HintText::Item(
        ...
        Text{ "Deku Seeds (30 pieces)", /*french*/ "une trentaine de graines Mojo",
              /*spanish*/ "unas (30) semillas deku", /*italian*/ "30 semi Deku", /*german*/ "Deutsch" });
    ...
    hintTable[DEKU_STICK_1] = HintText::Item(
        ...
        // clear text
        Text{ "a Deku Stick", /*french*/ "un bâton Mojo", /*spanish*/ "un palo deku", /*italian*/ "un ramo Deku",
              /*german*/ "Deutsch" });
    ...
    hintTable[TRIFORCE_PIECE] = HintText::Item(
        ...
        Text{ "a Piece of the Triforce", /*french*/ "un fragment de la Triforce",
              /*spanish*/ "un fragmento de la Trifuerza", /*italian*/ "un frammento di Triforza",
              /*german*/ "Deutsch" });
    ...
    //                      /*spanish*/"un error (repórtelo si es posible)", /*italian*/"un errore (segnalalo per
    //                      favore)", /*german*/"Deutsch"}
    // );
}
